...
@section('meta-info')
<title>Chairman's Message | Aeren Education</title>
<meta name="description" content="Message from the Chairman of Aeren Education - inspiring leadership and vision for quality education.">
@endsection
...
<!-- Hero Section -->
<section>
    <div class="banner chairman-bg d-flex align-items-center">
                ...
                <div class="message-card p-5 rounded-4 shadow-sm bg-white">
                    ...
                    <div class="message-content">
                        ...
                        <div class="signature mt-5">
                            ...
                            <p class="text-muted small">Chairman, Aeren Education</p>
                        </div>
                    </div>
                </div>
            </div>
